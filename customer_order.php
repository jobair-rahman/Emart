                    ...
                    <div class="row">
                        ...
                        if (mysqli_num_rows($query) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($query)) {
                                if ($trn != $row["trx_id"]) {
                                    if ($i % 2) {
                                        echo '<div class="col-md-6" style="height: 30vh"></div>';
                                    }
                                    echo '&nbsp;<hr>';
                                    $trn = $row["trx_id"];
                                    echo '<h2 class="text-center">Trx no. ' . $trn . '</h2>';
                                }
                                ?>
                                <div class="col-md-6" style="margin-top: 10px">
                                    <img style="float:right; width: 50%; height: 30vh"
